...
<div>
  <div v-if="fileList.length>0">
    ...
    <ul class="el-upload-list el-upload-list--picture-card">
      <li tabindex="0" v-for="file,index in fileList" :key="index" class="el-upload-list__item" style="width:200px;height:290px">
        ...
        <div style="padding: 14px;">
          <el-checkbox @change="checkFile()" v-if="!disabled" :label="file.name" :key="file.id" v-model="file.checked">{{file.name}}</el-checkbox>
