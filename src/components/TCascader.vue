<template>
<el-cascader ref="cascader" :placeholder="placeholder" :options="data" v-model="currentValue" v-bind="cascaderOptions" filterable clearable :change-on-select="changeOnSelect" @change="handleChange" :disabled="disabled"></el-cascader>
</template>
<script>
